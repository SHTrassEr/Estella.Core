...
(function (Estella) {
    ...
    (function (Core) {
        ...
        })(Core.WebSocketClientStatus || (Core.WebSocketClientStatus = {}));
        var WebSocketClientStatus = Core.WebSocketClientStatus;
    })(Core = Estella.Core || (Estella.Core = {}));
})(Estella || (Estella = {}));
var Estella;
(function (Estella) {
    ...
    (function (Core) {
        class WebSocketClient {
            constructor(entityFactory, id, client) {
                ...
                this.id = id;
                this.client = client;
                this.setStatus(Core.WebSocketClientStatus.Initialization);
                this.init();
            }
            init() {
            ...
            processMessage(attr) {
                if (this.status != Core.WebSocketClientStatus.Disconnected) {
                    if (attr && this.onMessageHandler) {
                        try {
                            ...
                            console.log(e);
                            this.status = Core.WebSocketClientStatus.Disconnected;
                        }
                    }
                }
            }
        ...
        Core.WebSocketClient = WebSocketClient;
    })(Core = Estella.Core || (Estella.Core = {}));
})(Estella || (Estella = {}));
var Estella;
(function (Estella) {
    ...
    (function (Core) {
        class WebSocketClientListService {
            ...
            addWebSocketClient(client) {
                ...
                let webSocketClient = new Core.WebSocketClient(this.entityFactory, newClientId, client);
        ...
        Core.WebSocketClientListService = WebSocketClientListService;
    })(Core = Estella.Core || (Estella.Core = {}));
})(Estella || (Estella = {}));
var Estella;
(function (Estella) {
    ...
    (function (Core) {
        class WebSocketGameServer {
            constructor(server, engine) {
                this.webSocketServer = new Core.WebSocketServer(server, engine.getWorld().getEntityFactory());
                this.engine = engine;
                this.init();
            }
            init() {
        ...
        Core.WebSocketGameServer = WebSocketGameServer;
    })(Core = Estella.Core || (Estella.Core = {}));
})(Estella || (Estella = {}));
var Estella;
(function (Estella) {
    ...
    (function (Core) {
        class WebSocketServer {
            constructor(server, entityFactory) {
                this.entityFactory = entityFactory;
                this.webSocketClientListService = new Core.WebSocketClientListService(entityFactory);
                this.server = server;
                this.init();
            }
            init() {
            ...
            sendAll(message) {
                ...
                for (let webSocketClient of webSocketClientList) {
                    if (webSocketClient.getStatus() == Core.WebSocketClientStatus.Connected) {
            ...
            onClientMessage(webSocketClient, message) {
                if (webSocketClient.getStatus() === Core.WebSocketClientStatus.Initialization && message instanceof Core.ClientServerMessageResponseAuthentication) {
            ...
            onClientDisconnected(webSocketClient) {
                webSocketClient.setStatus(Core.WebSocketClientStatus.Disconnected);
            }
            ...
            onClientConnected(webSocketClient) {
                webSocketClient.setStatus(Core.WebSocketClientStatus.Connected);
