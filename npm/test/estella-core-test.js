...
function getRandomString(stringLength = 20) {
    var text = "";
...
function getRandomInt(max = 1000000, min = -1000000) {
    return Math.floor(Math.random() * (max - min + 1)) + min;
}
function getRandomIntArray(count = 20, max = 1000000, min = -1000000) {
    var arr = [];
...
function getRandomStringArray(count = 20, stringLength = 20) {
    var arr = [];
    for (var i = 0; i < count; i++) {
